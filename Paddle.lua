...
--[[
    The `init` function on the class is called just once, when the object is first created. Used to set up all variables in the class and get it ready for use.

    The Paddle should take an X and a Y, for positioning, as well as a width and height for its dimensions.
